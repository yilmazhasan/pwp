...
$result = $conn->query("SELECT * FROM students");// or die(mysql_error());

if(!empty($_POST["code"]))
{
	$code = test_input($_POST["code"]);
	if (preg_match("/^[0-9]*$/",$code)) {
		$result = $conn->query("SELECT * FROM students WHERE code=$code") or die(mysql_error());	
...
echo "<tr align='left'><th col width = '30'>#</th> <th>CODE</th> <th>Name</th> <th>Lastname</th> 
